	...
	public void actionPerformed(ActionEvent ae)
	{
		try
		{
			...
			if(ae.getSource() == b1)
			{
				...
				JOptionPane.showMessageDialog(null,"Rs. 100 is debited successfully");
			...
			else if(ae.getSource() == b2)
			{
				...
				JOptionPane.showMessageDialog(null,"Rs.500 is debited successfully");
				new Transactions().setVisible(true);
				setVisible(true);
			}
			...
			else if(ae.getSource() == b3)
			{
				...
				JOptionPane.showMessageDialog(null,"Rs. 1000 is debited successfully");
				new Transactions().setVisible(true);
				setVisible(true);
			}
			...
			else if(ae.getSource() == b4)
			{
				...
				JOptionPane.showMessageDialog(null,"Rs. 2000 is debited successfully");
				new Transactions().setVisible(true);
				setVisible(true);
			}
			...
			else if(ae.getSource() == b5)
			{
				...
				JOptionPane.showMessageDialog(null,"Rs. 5000 is debited successfully");
				new Transactions().setVisible(true);
				setVisible(true);
			}
			...
			else if(ae.getSource() == b6)
			{
				...
				JOptionPane.showMessageDialog(null,"Rs. 10000 is debited successfully");
				new Transactions().setVisible(true);
				setVisible(true);
			}
